        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TourImageId = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_TourImages_TourImageId",
                        column: x => x.TourImageId,
                        principalTable: "TourImages",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickUpTİme = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PickUpPlace = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReturnPlace = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tours_TourImages_TourImageId",
                        column: x => x.TourImageId,
                        principalTable: "TourImages",
                        principalColumn: "Id");
                    table.ForeignKey(
